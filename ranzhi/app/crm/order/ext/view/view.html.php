...
<div class='row-table'>
  <div class='col-main'>
    ...
    <div class='page-actions'>
      ...
      if(count($order->products) == 1 && !empty($order->enabledActions))
      {
          foreach($order->enabledActions as $action) echo html::a($this->inlink('operate', "orderID={$order->id}&action={$action->id}"), $action->name, "class='btn'");
      }
      echo '</div>';
