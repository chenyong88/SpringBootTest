  ...
  <div class='main'>
    <div class='panel'>
      <div class='panel-heading'>
        <strong><i class='icon-plus'></i> <?php echo $lang->leads->createSite;?></strong>
      </div>
          ...
          <table class='table table-form'>
            <tr>
              ...
              <td class='w-p50'>
                ...
                <?php echo html::input('name', '', "class='form-control' placeholder='{$lang->leads->tips->name}'");?>
              </td>
              <td></td>
            </tr>
            <tr>
              ...
              <td>
                <div class='required required-wrapper'></div>
                <?php echo html::input('code', '', "class='form-control' placeholder='{$lang->leads->tips->code}'");?>
              </td>
              <td></td>
            </tr>
            <tr>
              ...
              <td>
                <div class='required required-wrapper'></div>
                <?php echo html::input('url', '', "class='form-control' placeholder='{$lang->leads->tips->url}'");?>
              </td>
              <td></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <div class='required required-wrapper'></div>
                <?php echo html::select('modules[]', $lang->leads->actionList, '', "class='form-control chosen' multiple='multiple'");?>
              </td>
            </tr>
            <tr>
