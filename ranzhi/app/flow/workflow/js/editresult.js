$(document).ready(function()
{
    ...
    $(document).on('change', '[name*=paramType]', function()
    {
        ...
        else if($(this).val() == 'custom')
        {
            ...
            var link  = createLink('workflow', 'ajaxGetFieldControl', 'module=' + v.module + '&fieldCode=' + fieldCode + '&value=' + value + '&elementName=' + window.btoa(name) + '&elementID=' + id);
    ...
    $(document).on('click', '.addVar, .addCondition, .addField, .addWhere', function()
    {
        ...
        {
            $(this).parents('tr').after(v.varRow);
        }
