        ...
        <div class="panel-actions pull-right">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu pull-right">
              <?php commonModel::printLink('project', 'effortcalendar', "projectID=$project->id", $lang->project->effort, '', '', '', 'li');?>
...
<div class='panel hide' id='listMode'>
  <table class='table table-hover table-striped tablesorter table-fixed table-data'>
    ...
    <tr class='text-center' data-url='<?php echo $browseLink;?>'>
      ...
      <td>
        <?php commonModel::printLink('project', 'effortcalendar', "projectID=$project->id", $lang->project->effort);?>
