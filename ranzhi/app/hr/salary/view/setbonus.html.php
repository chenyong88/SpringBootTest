  ...
  <form id='ajaxForm' method='post'>
    <div class='panel'>
      <div class='panel-heading'>
        <strong><i class="icon-wrench"></i> <?php echo $lang->salary->setBonus;?></strong>
      </div>
      <div class='panel-body'>
        <table class='table table-condensed table-borderless'>
          <tr class='text-center'>
            ...
            <th class='w-180px'><?php echo $lang->salary->rule;?></th>
            <th></th>
          </tr>
          <?php $i = 0;?>
          <?php foreach($bonusList as $name => $bonus):?>
          <tr class='text-middle'>
            <td class='text-center'>
              <?php echo $name;?>
              <?php echo html::hidden("names[$i]", $name);?>
            </td>
            <td><?php echo html::input("amounts[$i]", $bonus->amount, "class='form-control amount'");?></td>
            <td class='ruleTD'>
              <?php echo zget($lang->salary->ruleList, $bonus->rule, ' ');?>
              <?php echo html::hidden("rules[$i]", $bonus->rule, "class='form-control rule'");?>
            </td>
            <td>
              <?php if(!in_array($name, $lang->salary->bonusList)):?>
