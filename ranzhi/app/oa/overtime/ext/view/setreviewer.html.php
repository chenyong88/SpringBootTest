...
<div class='panel'>
  <div class='panel-heading'>
    ...
    <div class='panel-actions pull-right'>
     <?php echo html::a('#copyReviewerModal', "<i class='icon icon-copy'> </i>" . $lang->overtime->copyReviewer, "class='btn' data-toggle='modal'");?>
    </div>
    <?php endif;?>
  </div>
  <div class='panel-body'>
    <form id='ajaxForm' method='post'>
      ...
      <tr>
        <th class='w-100px'><?php echo $lang->overtime->multiReviewer;?></th>
        <td><?php echo html::radio('turnon', $lang->overtime->multiReviewerStatusList, !empty($multiReviewer));?></td>
        <td></td>
      </tr>
      <?php $i = 1;?>
      ...
      <?php endif;?>
      <tr>
        <th class='w-100px'><?php echo $lang->overtime->reviewers;?></th>
...
<div class='modal fade' id='copyReviewerModal'>
  <div class='modal-dialog w-400px'>
    <div class='modal-header'>
      ...
      <h4 class='modal-title'><?php echo $lang->overtime->copyReviewer;?></h4>
    </div>
