...
<div class='panel'>
  <div class='panel-heading'>
    <strong><?php echo $lang->makeup->setReviewer;?></strong>
    <?php if($modules):?>
    <div class='panel-actions pull-right'>
     <?php echo html::a('#copyReviewerModal', "<i class='icon icon-copy'> </i>" . $lang->makeup->copyReviewer, "class='btn' data-toggle='modal'");?>
    </div>
    <?php endif;?>
  </div>
  <div class='panel-body'>
    <form id='ajaxForm' method='post'>
      ...
      <tr>
        <th class='w-100px'><?php echo $lang->makeup->multiReviewer;?></th>
        <td><?php echo html::radio('turnon', $lang->makeup->multiReviewerStatusList, !empty($multiReviewer));?></td>
        <td></td>
      </tr>
      <?php $i = 1;?>
      ...
      <?php endif;?>
      <tr>
        <th class='w-100px'><?php echo $lang->makeup->reviewers;?></th>
...
<div class='modal fade' id='copyReviewerModal'>
  <div class='modal-dialog w-400px'>
    <div class='modal-header'>
      ...
      <h4 class='modal-title'><?php echo $lang->makeup->copyReviewer;?></h4>
    </div>
