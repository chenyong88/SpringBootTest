<?php
/**
 * The linkContact mobile view file of provider module of RanZhi.
 *
...
<div class='heading divider'>
  <div class='title'><strong><?php echo $lang->provider->linkContact ?></strong></div>
  <nav class='nav'><a data-dismiss='display'><i class='icon-remove muted'></i></a></nav>
</div>

<form class='content box' data-display-from='providerContactsModal' method='post' id='linkContactForm' action='<?php echo $this->createLink('provider', 'linkContact', "providerID=$providerID")?>'>
  <div class='control'>
    ...
    <label><?php echo $lang->provider->contact;?></label>
