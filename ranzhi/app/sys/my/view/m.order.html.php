...
<div class='heading'>
  ...
  <nav class='nav'>
    <a class='btn primary' data-display='modal' data-placement='bottom' data-remote='<?php echo $this->createLink('crm.order', 'create') ?>'>
...
<section id='page' class='section list-with-pager'>
  <?php $refreshUrl = $this->createLink('my', 'order', "type=$type&orderBy=$orderBy&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}&pageID={$pager->pageID}");?>
  <div class='box' data-page='<?php echo $pager->pageID ?>' data-refresh-url='<?php echo $refreshUrl ?>'>
    <table class='table bordered no-margin'>
      ...
      <tr class='text-center' data-url='<?php echo $this->createLink('crm.order', 'view', "orderID={$order->id}");?>' data-id='<?php echo $order->id;?>'>
...
<div class='list sort-panel hidden affix enter-from-bottom layer' id='sortPanel'>
  ...
  $sortOrders = array('id', 'level', 'customer', 'product', 'plan', 'real', 'assignedTo', 'status', 'contactedDate', 'nextDate');
