...
$lang->effort->menu->weekly    = '周報|effort|browseWeekly|';
...
$lang->product->menu->settings = '設置|product|browseProperties|module=product&section=models';
...
$lang->receivable->menu->receivable = '應收款|receivable|receivable|';
...
$lang->payable->menu->payable = '應付款|payable|payable|';
$lang->payable->menu->paid    = '已付款|payable|paid|';

$lang->payable->menuOrder[5]  = 'payable';
$lang->payable->menuOrder[10] = 'paid';

$lang->menu->dashboard->effort = '日誌|effort|calendar|';
$lang->menu->dashboard->salary = '工資|my|salary|type=personal';
...
$lang->my->salary->menu->personal = '我的工資|my|salary|type=personal';

$lang->my->salary->menuOrder[5] = 'personal';

$lang->my->company = new stdclass();
$lang->my->company->menu = new stdclass();
$lang->my->company->menu->todo   = '待辦|my|company|type=todo';
$lang->my->company->menu->effort = '日誌|my|company|type=effort';
$lang->my->company->menu->weekly = '周報|my|company|type=weekly';

$lang->my->company->menuOrder[5]  = 'todo';
$lang->my->company->menuOrder[10] = 'effort';
$lang->my->company->menuOrder[15] = 'weekly';

$lang->system->menu->psi        = '進銷存|setting|psi|';
$lang->system->menu->wechat     = array('link' => '企業微信|wechat|setting|', 'alias' => 'replaceUsersToSystem, replaceDeptToSystem');
$lang->system->menu->ldap       = 'LDAP配置|ldap|set|';
$lang->system->menu->buildIndex = '重建索引|search|buildindex|';
$lang->system->menu->license    = '授權|admin|license|';
