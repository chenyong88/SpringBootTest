<div id='psiCreateInfo' class='hide'>
  ...
  <table class='table table-form'>
    <tr>
      ...
      <td>
        <div class='input-group'>
          <?php echo html::select('category', $categories, '', "class='form-contorl'");?>
      ...
      <td><?php echo html::select('type', $lang->product->typeList, 'real', "class='form-control' style='height:34px; margin-bottom: 5px;'");?></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <div class='input-group'>
          <?php echo html::select('model', array('') + $lang->product->models, '', "class='form-contorl'");?>
      ...
      <td>
        <div class='input-group'>
          <?php echo html::select('unit', array('') + $lang->product->units, '', "class='form-contorl'");?>
    ...
    <tr>
      ...
      <td><?php echo html::select('store', $stores, '', "class='form-contorl'");?></td>
...
<script>
  ...
  {
      $('#ajaxForm').empty().append($('#psiCreateInfo').html()); 
