<?php
/**
 * The edit invoice view file of customer module of RanZhi.
 *
...
<form id='invoiceForm' method='post' action='<?php echo inlink('editInvoice', "invoiceID=$invoice->id")?>'>
  <table class='table table-form'>
    ...
    <tr>
      ...
      <td><?php echo html::input('registedAddress', $invoice->registedAddress, "class='form-control'")?></td>
    </tr>
    <tr>
      <th><?php echo $lang->customer->phone;?></th>
      <td><?php echo html::input('phone', $invoice->phone, "class='form-control'")?></td>
    </tr>
    <tr>
      <th><?php echo $lang->customer->bankName;?></th>
      <td><?php echo html::input('bankName', $invoice->bankName, "class='form-control'")?></td>
    </tr>
    <tr>
      <th><?php echo $lang->customer->bankAccount;?></th>
      <td><?php echo html::input('bankAccount', $invoice->bankAccount, "class='form-control'")?></td>
    </tr>
    <tr>
      <th></th>
