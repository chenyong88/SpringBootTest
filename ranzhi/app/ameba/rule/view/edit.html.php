<?php
/**
 * The edit view file of rule module of Ranzhi.
 *
...
<div class='panel'>
  <div class='panel-heading'>
    <strong><?php echo $lang->rule->edit;?></strong>
  </div>
  <div class='panel-body'>
    <form id='ajaxForm' method='post'>
      <table class='table table-form'>
        <tr>
          <th class='w-80px'><?php echo $lang->rule->year;?></th>
          <td class='w-220px'><?php echo html::select('year', $yearList, substr($rule->month, 0, 4), "class='form-control chosen'");?></td>
          <td></td>
          <td></td>
          <td></td>
          <td class='w-120px'></td>
        ...
        <tr>
          <th><?php echo $lang->rule->month;?></th>
          <td><?php echo html::select('month', $lang->rule->monthList, substr($rule->month, 4, 2), "class='form-control chosen'");?></td>
          <td colspan='5'></td>
        </tr>
        <tr>
          <th><?php echo $lang->rule->from;?></th>
          <td><?php echo html::select('from', $deptList, $rule->from, "class='form-control chosen'");?></td>
          <td colspan='5'></td>
        </tr>
        <tr>
          <th><?php echo $lang->rule->product;?></th>
          <td><?php echo html::select('product', $productList, $rule->product, "class='form-control chosen'");?></td>
          <td colspan='5'></td>
        </tr>
        <tr>
          <th><?php echo $lang->rule->category;?></th>
          <td><?php echo html::select('category', $categoryList, $rule->category, "class='form-control chosen'");?></td>
          <td colspan='5'></td>
        </tr>
        <tr>
          ...
          <td class='nopaddingleft' colspan='6'>
            <table class='table table-form tableRules'>
              ...
              <tr>
                <td><?php echo html::select('shareRules[fromCategory][]', $expenseList, $sharedRule->fromCategory, "class='form-control chosen' data-placeholder='{$lang->rule->fromCategory}'");?></td>
                <td class='fixpadding'><?php echo html::select('shareRules[to][]', $deptList, $sharedRule->to, "class='form-control chosen' data-placeholder='{$lang->rule->to}'");?></td>
                <td class='fixpadding'><?php echo html::select('shareRules[toCategory][]', $incomeList, $sharedRule->toCategory, "class='form-control chosen' data-placeholder='{$lang->rule->toCategory}'");?></td>
                <td class='w-120px fixpadding'>
                  <div class='input-group'>
                    <?php echo html::input('shareRules[rate][]', $sharedRule->rate, "class='form-control' placeholder='{$lang->rule->rate}'");?>
